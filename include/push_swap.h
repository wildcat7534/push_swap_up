...
/*   Updated: 2024/12/08 18:52:50 by cmassol          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void						init_start(t_node **a, t_node **b,
								t_lst_instruct **it);
void						free_lst_instruct(t_lst_instruct *lsti);
void						ft_lst_instruc(t_lst_instruct **instruct,
								char *lsti);
